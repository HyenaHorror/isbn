...
class ISBN_Test < Minitest::Test
  ...
  #   actual = rs.to_a[0]
  #   pass = BCrypt::Password.new(actual["passhash"])
  #   # rescue BCrypt::Errors::InvalidHash
  #   expected = {"id" => id.to_s, "username" => username, "name" => name, "passhash" => pass}
  #   assert_equal(expected, actual)
  # end
  ...
  def test_x_conversion
    assert_equal(false, process_isbn("9786082211X7"))
  end
end
